...
<div class="modal fade modalItensDuplicados" id="exampleModalItensDuplicados" tabindex="-1" aria-labelledby="exampleModalLabelItensDuplicados" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabelItensDuplicados" style="color: red">ITENS DE PRODUTOS DUPLICADOS!</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
