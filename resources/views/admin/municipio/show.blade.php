...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h5 class="h5 mb-4 text-gray-800"> Suporte / Municípios / Exibir</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control" id="nome" name="nome" value="{{$municipio->nome}}" readonly>
                                        @error('nome')
                                    ...
                                    <div class="form-group focused">
                                        ...
                                        <div style="margin-top: 5px">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="ativo" id="ativosim" value="1"  {{old('ativo', $municipio->ativo) == '1' ? 'checked' : ''}}  disabled>
                                                <label class="form-check-label" for="ativosim">Sim</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="ativo" id="ativonao" value="0"  {{old('ativo', $municipio->ativo) == '0' ? 'checked' : ''}}  disabled>
