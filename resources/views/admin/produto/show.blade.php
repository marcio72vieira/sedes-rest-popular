...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h5 class="h5 mb-4 text-gray-800"> Suporte / Produtos / Exibir</h5>
                    ...
                    <form action="" method="" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="categoria_id">Categoria<span class="small text-danger">*</span></label>
                                    ...
                                    <div class="form-group focused">
                                        ...
                                        <div style="margin-top: 5px">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="ativo" id="ativosim" value="1"  {{old('ativo', $produto->ativo) == '1' ? 'checked' : ''}}  disabled>
                                                <label class="form-check-label" for="ativosim">Sim</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="ativo" id="ativonao" value="0"  {{old('ativo', $produto->ativo) == '0' ? 'checked' : ''}}  disabled>
