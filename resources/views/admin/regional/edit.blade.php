...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h5 class="h5 mb-4 text-gray-800"> Suporte / Regionais / Editar</h5>
        ...
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.regional.update', $regional->id)}}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control" id="nome" name="nome" value="{{old('nome', $regional->nome)}}" required>
                                        @error('nome')
