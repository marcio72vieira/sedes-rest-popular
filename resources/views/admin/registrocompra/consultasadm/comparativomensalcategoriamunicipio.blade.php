...
<div class="container-fluid">
    ...
    <h5><strong>Consultas / Comparativo mensal de categorias adquiridos por município: {{ $records[0]->municipio_nome }} - {{ $mesano }} </h5>
                    ...
                    <table id="myTable" class="table table-sm table-bordered  table-hover">
                        <thead  class="bg-gray-100">
                            <tr>
                                ...
                                <th colspan="8">Município: {{ $records[0]->municipio_nome }} - Categoria: {{ Str::upper($records[0]->categoria_nome) }} ({{ Str::upper($records[0]->medida_simbolo) }})</th>
                                <th colspan="2">Mês:{{ $mesano }}</th>
                                <th colspan="2" style="text-align: right"><a class="btn btn-primary btn-danger btn-sm" href="{{ route('admin.registroconsultacompra.relpdfcomparativomensalcategoriamunicipio', [$categ_id, $medi_id, $muni_id, $mes_id, $ano_id]) }}" role="button" target="_blank"><i class="far fa-file-pdf"  style="font-size: 15px;"></i> pdf</a></th>
                            </tr>
                            <tr>
                                <th scope="col" rowspan="3" style="width: 40px; text-align: center; vertical-align:middle">Id</th>
                                <th colspan="2" rowspan="3" scope="col"  style="width: 200px; text-align: center; vertical-align:middle">Restaurante</th>
                        ...
                        <tbody>
                                ...
                                @foreach ($records as $item)
                                    <tr>
                                        ...
                                        <td colspan="2">{{ $item->identificacao }}</td>
