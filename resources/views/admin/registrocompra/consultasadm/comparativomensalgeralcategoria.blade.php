...
<div class="container-fluid">
    ...
    <h5><strong>Consultas / Comparativo mensal Geral de categoria adquirida: {{ $mesano }} </h5>
                    ...
                    <table id="myTable" class="table table-sm table-bordered  table-hover">
                        <thead  class="bg-gray-100">
                            <tr>
                                ...
                                <th colspan="2" style="text-align: right"><a class="btn btn-primary btn-danger btn-sm" href="{{ route('admin.registroconsultacompra.relpdfcomparativomensalgeralcategoria', [$categ_id, $medi_id, $mes_id, $ano_id]) }}" role="button" target="_blank"><i class="far fa-file-pdf"  style="font-size: 15px;"></i> pdf</a></th>
                            </tr>
                            <tr>
