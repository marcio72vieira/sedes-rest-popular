...
<div class="container-fluid">
    ...
    <h5><strong>Consultas / Comparativo mensal de produto adquiridos por município: {{ $records[0]->municipio_nome }} - {{ $mesano }} </h5>
                    ...
                    <table id="myTable" class="table table-sm table-bordered  table-hover">
                        <thead  class="bg-gray-100">
                            <tr>
                                ...
                                <th colspan="8">Município: {{ $records[0]->municipio_nome }} - Produto: {{ Str::upper($records[0]->produto_nome) }} ({{ Str::upper($records[0]->medida_simbolo) }})</th>
                                <th colspan="2">Mês:{{ $mesano }}</th>
                                <th colspan="2" style="text-align: right"><a class="btn btn-primary btn-danger btn-sm" href="{{ route('admin.registroconsultacompra.relpdfcomparativomensalprodutomunicipio', [$prod_id, $medi_id, $muni_id, $mes_id, $ano_id]) }}" role="button" target="_blank"><i class="far fa-file-pdf"  style="font-size: 15px;"></i> pdf</a></th>
                            </tr>
                            <tr>
