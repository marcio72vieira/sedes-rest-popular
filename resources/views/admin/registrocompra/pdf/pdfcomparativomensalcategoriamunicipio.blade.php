...
<head>
    ...
    <title>SEDES - Comparativo mensal de categorias no município</title>
</head>
    ...
    <table style="width: 1080px; border-collapse: collapse;">
        ...
        @foreach ($records as $item)
            <tr @if($loop->even) style="background-color: #e3e3e3;"; $par = 1;  @endif>
                <td style="width: 40px;" class="dados-lista">{{ $item->restaurante_id }}</th>
                <td style="width: 320px;" class="dados-lista">{{ $item->identificacao }}</td>
