...
<head>
    ...
    <title>SEDES - Mapa mensal de produtos adquiridos por unidade no restaurante</title>
</head>
    ...
    <table style="width: 1080px; border-collapse: collapse;">
        ...
        @foreach ($records as $item)
            <tr @if($loop->even) style="background-color: #e3e3e3;"; $par = 1;  @endif>
                <td style="width: 40px;" class="dados-lista">{{ $item->produto_id }}</th>
                <td style="width: 280px;" class="dados-lista">{{ $item->produto_nome }}</td>
