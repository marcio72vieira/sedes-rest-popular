...
<head>
    ...
    <title>SEDES - Compra mensal restaurante</title>
</head>
...
<body>
    ...
    <table  style="width: 717px; border-collapse: collapse; margin-top:3px;">
        <tr>
            <td style="width: 637px; text-align: right; padding: 3px" class="dados-box-top dados-box-bottom"><strong>Valor Total R$</strong> </td>
