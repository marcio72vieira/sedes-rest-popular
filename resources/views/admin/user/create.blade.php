...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h5 class="h5 mb-4 text-gray-800">Usuarios / Cadastrar</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="crn" class="form-control" name="crn" value="{{old('crn')}}" required>
                                        @error('crn')
                                            <small style="color: red">{{$message}}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group focused">
                                        ...
                                        <select name="perfil" id="perfil" class="form-control" required>
                                            ...
                                            <option value="nut" {{old('perfil') == 'nut' ? 'selected' : ''}}>Nutricionista</option>
                                            <option value="ina" {{old('perfil') == 'ina' ? 'selected' : ''}}>Inativo</option>
                                        </select>
                                        @error('perfil')
                                            <small style="color: red">{{$message}}</small>
                                        @enderror
