...
Route::get('admin/monitor/{identidade}/{idcategoria?}/{idproduto?}/{idano}/pdf/relpdfmonitorentidade', [MonitorController::class, 'relpdfmonitorentidade'])->name('admin.monitor.relpdfmonitorentidade')->middleware(['auth']);
